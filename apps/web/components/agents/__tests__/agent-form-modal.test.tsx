...
describe('AgentFormModal', () => {
  ...
  it('renders modal with title when open', () => {
    render(<AgentFormModal open onClose={onClose} onSubmit={onSubmit} />);
    expect(screen.getByRole('dialog')).toBeTruthy();
    expect(screen.getByText(/new agent/i)).toBeTruthy();
  });

  it('renders edit title when agent provided', () => {
    render(<AgentFormModal open onClose={onClose} onSubmit={onSubmit} agent={defaultAgent} />);
    expect(screen.getByText(/edit agent/i)).toBeTruthy();
  });

  it('does not render when closed', () => {
    render(<AgentFormModal open={false} onClose={onClose} onSubmit={onSubmit} />);
