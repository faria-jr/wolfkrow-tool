/**
 * Extração de entidades/relações p/ o knowledge graph .
 *
...
const TECH_TERMS =
  /\b(API|REST|GraphQL|HTTP|SQL|JSON|XML|CSV|PDF|URL|URI|JWT|OAuth|CORS|CDN|DNS|TLS|SSL|TCP|IP|SDK|CLI|IDE|CI|CD|AWS|GCP|Azure)\b/g;
