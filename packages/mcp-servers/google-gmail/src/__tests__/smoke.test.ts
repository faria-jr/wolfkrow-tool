    ...
    const res = await handleRpcMessage(
      {
        ...
        id: 3,
        method: 'tools/call',
        params: { name: 'gmail_search_messages', arguments: { query: 'from:boss@example.com' } },
      },
      handlers
    );
    ...
    const res = await handleRpcMessage(
      {
        ...
        id: 4,
        method: 'tools/call',
        params: { name: 'gmail_get_message', arguments: { messageId: 'msg1' } },
      },
      handlers
    );
    ...
    const res = await handleRpcMessage(
      {
        ...
        id: 5,
        method: 'tools/call',
        params: { name: 'gmail_search_messages', arguments: { query: 'test' } },
      },
      handlers
    );
