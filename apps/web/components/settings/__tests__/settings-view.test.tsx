...
const HUB_ROUTES = ['/settings/providers', '/settings/voice', '/vault'] as const;
...
describe('SettingsView', () => {
  ...
  it('does not duplicate items that already live in the sidebar', () => {
    ...
    for (const sidebarRoute of [
      ...
      expect(hrefs, `hub must not duplicate sidebar entry ${sidebarRoute}`).not.toContain(
        sidebarRoute
      );
    }
  });
