...
describe('SkillList', () => {
  ...
  it('renders skill name and tags', () => {
    render(<SkillList skills={[skill]} onEdit={vi.fn()} onDuplicate={vi.fn()} onDelete={vi.fn()} />);
  ...
  it('exposes duplicate action for every skill row', async () => {
    ...
    render(<SkillList skills={[skill]} onEdit={vi.fn()} onDuplicate={onDuplicate} onDelete={vi.fn()} />);
  ...
  it('hides edit/delete buttons for built-in skills', () => {
    render(<SkillList skills={[{ ...skill, isBuiltIn: true }]} onEdit={vi.fn()} onDuplicate={vi.fn()} onDelete={vi.fn()} />);
