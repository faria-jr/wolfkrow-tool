...
export const PLANNED_MCP_SERVERS: readonly BuiltInMcpEntry[] = [
 { name: 'skills', description: 'Skills MCP server (alias for wolfkrow-skills)', command: 'node', args: [], visibility: 'always' },
 { name: 'wolfkrow-agents', description: 'Internal agents (alias for local-agents)', command: 'node', args: [], visibility: 'always' },
